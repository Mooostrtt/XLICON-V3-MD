    ...
    const fkontak = {
      ...
      message: {
        contactMessage: {
          ...
          vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=201030982295+:201030982295+\nitem1.X-ABLabel:Mobile\nEND:VCARD`,
          jpegThumbnail: thumb,
          thumbnail: thumb,
          sendEphemeral: true,
        },
...
`.trim(),
    ...
    switch (isCommand) {
      ...
      case "upswaudio":
        ...
        break;
      case "setimgmenu":case "اعدادت.الاوامر":
      case "sim":
        {
          if (!XeonTheCreator) return XliconStickOwner();
        ...
        if (args.length < 1)
          return replygcXlicon(
            `*_Usage ${prefix + command} @tag\n${
              prefix + command
            } number\n\nExample : ${prefix + command} 201030982295+_*`
          );
        if (m.mentionedJid.length !== 0) {
          for (let i = 0; i < m.mentionedJid.length; i++) {
      ...
      case "shutdown":
        ...
        process.exit();
        break;
      case "autoread":case "مشاهدة.الرساله":
        if (!XeonTheCreator) return XliconStickOwner();
        if (args.length < 1)
...
╭⏤͟͟͞͞★
│➛ ${xprefix}ᴀʟʟᴍᴇɴᴜ او الاوامر.كله
│➛ ${xprefix}ᴅᴏᴡɴʟᴏᴀᴅᴍᴇɴᴜ او اوامر التحميل
│➛ ${xprefix}ғᴜɴᴍᴇɴᴜ او اوامر ممتعه
│➛ ${xprefix}ᴀɪᴍᴇɴᴜ او اوامرai
│➛ ${xprefix}ɢʀᴏᴜᴘᴍᴇɴᴜ او اوامر المجموعه
│➛ ${xprefix}ᴏᴡɴᴇʀᴍᴇɴᴜ او اوامر.المالك
...
╰▱╼❲⭐❳`;
        ...
        break;
      case "allmenu":case "الاوامر.كله":case "الأوامر كله":case "الاوامر كله":case "كل الاوامر":
        {
...
└⟝————ᙍᙊ
        ...
        break;
      case "ownermenu":case "اوامر.المالك":
        {
      ...
      case "othermenu":
        ...
        break;
      case "downloadmenu":case "اوامر التحميل":
      case "dlmenu":
        {
          let xmenu_oh = `Hi ${pushname}${readmore}\n\n${downloadmenu(
            prefix,
        ...
        break;
      case "groupmenu":case "اوامر المجموعه":
        {
          let xmenu_oh = `Hi ${pushname}${readmore}\n\n${groupmenu(
            prefix,
            hituet
